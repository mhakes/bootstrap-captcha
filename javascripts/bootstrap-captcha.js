(function ($) {
    ...
    $.fn.bootstrapCaptcha = function (userOptions) {
        ...
        this.resetTitle = 'Oops...try again';
        ...
        that.makeLayout = function () {
            ...
            $('<ul/>', {
                'class': "span4 offset4 text-center well well-small alert alert-danger",
                id: 'bsCaptchaTarget'
